...
class DdqnAgent:
    ...
    def save(self, msg=""):
        torch.save(self.q.state_dict(), "./models/ddqn_q_model" + msg + ".pt")
        torch.save(self.target.state_dict(), "./models/ddqn_target_model" + msg + ".pt")

    def load(self, msg=""):
        self.q.load_state_dict(torch.load("./models/ddqn_q_model" + msg + ".pt"))
        self.q.eval()
        self.target.load_state_dict(torch.load("./models/ddqn_target_model" + msg + ".pt"))
        self.target.eval()
        print('loaded')
